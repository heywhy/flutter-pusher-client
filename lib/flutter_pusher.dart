...
class Channel {
  ...
  void _subscribe() async {
    var args = jsonEncode(
        BindArgs(instanceId: pusher!._instanceId as int, channelName: this.name)
            .toJson());
...
class BindArgs {
  ...
  BindArgs({this.channelName, this.eventName, required this.instanceId})
